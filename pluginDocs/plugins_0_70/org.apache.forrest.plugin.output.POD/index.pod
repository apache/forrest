...
Once you have the text plugin installed, it is simply a case of requesting a file with a pod extension. For example, L<this page as pod|index.pod> . 
...
Edit your C<forrest.properties > file and add C<org.apache.forrest.plugin.pod-output > to the C<project.required.plugin > property. 
