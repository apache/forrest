...
This next paragraph has a class attribute of 'quote'. CSS [Cascading Style Sheets] can be used to present this C<<p class='quote'> > in a different style than the other paragraphs. The handling of this quoted paragraph is defined in the <extra-css> element in the skinconf.xml. 
