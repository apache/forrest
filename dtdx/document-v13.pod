...
B<C<<link href="../index.html#History"> > >
...
B<C<<jump href="../index.html"> > >


=over 4

Use this to L<jump|../index> to another document and optionally go to a named L<anchor|../index/"overview"> within that document. This will open the new document in the same browser window. So what is the difference between link and jump? The jump behaves differently, in that it will replace any frames in the current window. This is the equivalent of C<<a ... target="_top"> > 


=back

B<C<<fork href="../index.html"> > >


=over 4

Use this to L<fork|../index> your webbrowser to another document. This will open the document in a new, unnamed browser window. This is the equivalent of C<<a ... target="_blank"> > 
