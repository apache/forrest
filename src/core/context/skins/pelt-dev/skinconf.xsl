...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <!-- Lenya -->
    ...
    <color name="navstrip" value="#F5F4E9" font="#000000"/>

    <color name="toolbox" value="#CFDCED" font="#000000"/>

    <color name="border" value="#999999"/>
    <color name="menu" value="#E5E4D9" font="#000000" link="#000000" vlink="#000000" hlink="#000000" current="#3366CC" />    
    ...
    <xsl:template match="colors">
     ...
     <xsl:if test="not(color[@name='subheading'])">
      ...
      <xsl:if test="not(color[@name='published'])">
		<color name="feedback" value="#4C6C8F" font="#FFFFFF" align="right"/>
     </xsl:if> 
     <xsl:if test="not(color[@name='published'])">
