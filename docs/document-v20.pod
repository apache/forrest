...
B<Hint: > See the xml source to see how the various elements are used and see the L<DTD reference documentation|../docs/dtd-docs> . 
...
See the generated L<DTD reference documentation|../docs/dtd-docs> . 
