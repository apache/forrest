          ...
          <office:body>
            <draw:page draw:name="page1" draw:style-name="dp1" draw:id="1" draw:master-page-name="Default" presentation:presentation-page-layout-name="AL1T0">
              <draw:text-box presentation:style-name="pr1" draw:layer="layout" svg:width="23.912cm" svg:height="3.508cm" svg:x="2.058cm" svg:y="1.743cm" presentation:class="title">
                <text:p text:style-name="P1">This is the title</text:p>
              </draw:text-box>
        ...
        <office:document-settings xmlns:office="http://openoffice.org/2000/office"
          ...
          <office:settings>
            ...
            <config:config-item-set config:name="configuration-settings">
              ...
              <config:config-item config:name="BitmapTableURL" config:type="string">file:///C:/Program%20Files/OpenOffice.org1.1.2/user/config/standard.sob</config:config-item>
              <config:config-item config:name="CharacterCompressionType" config:type="short">0</config:config-item>
              <config:config-item config:name="ColorTableURL" config:type="string">file:///C:/Program%20Files/OpenOffice.org1.1.2/user/config/standard.soc</config:config-item>
              <config:config-item config:name="DashTableURL" config:type="string">file:///C:/Program%20Files/OpenOffice.org1.1.2/user/config/standard.sod</config:config-item>
              <config:config-item config:name="DefaultTabStop" config:type="int">1270</config:config-item>
              <config:config-item config:name="GradientTableURL" config:type="string">file:///C:/Program%20Files/OpenOffice.org1.1.2/user/config/standard.sog</config:config-item>
              <config:config-item config:name="HatchTableURL" config:type="string">file:///C:/Program%20Files/OpenOffice.org1.1.2/user/config/standard.soh</config:config-item>
              ...
              <config:config-item config:name="LineEndTableURL" config:type="string">file:///C:/Program%20Files/OpenOffice.org1.1.2/user/config/standard.soe</config:config-item>
